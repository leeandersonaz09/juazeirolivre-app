...
const Home = () => {
    ...
    function shareContent(){
        Share.share({
            message: 'Por uma Juazeiro livre e transparente, compartilhe a causa com seus amigos nas mídias sociais!',
            url: 'https://www.juazeirolivre.com/',
            title: 'Juazeiro Livre'
          }, {
            // Android only:
            dialogTitle: 'Compartilhe nossa causa com seus amigos!',
            // iOS only:
                        ...
                        <Card style={{flex: 0}}>
                            <CardItem>
                                <Left>
                                    ...
                                    <Body>
                                        <Text>Cléber Souza de Jesus</Text>
                            ...
                            <CardItem>
                                <Body>
                                    ...
                                    <Text numberOfLines={lines} ellipsizeMode='tail' style={styles.Text}>
